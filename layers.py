LAYERS = {
    ...
    "SystemDeps": {
        ...
        "libraries": [
            ...
            "libicudata.so", "libicui18n.so", "libicuuc.so", "libjpeg.so", "libc.a", "libgcc_s.so.1", "libm.a",
            "libsecret-1.so", "libsoup-2.4.so", "libpango-1.0.so", "libpangocairo-1.0.so", "libpng.so", "libpthread.a",
            "libsqlite3.so", "libstdc++.so.6", "libX11.so", "libXcomposite.so", "libXdamage.so", "libXfixes.so",
            "libXrender.so", "libXt.so", "libwebp.so", "libz.so",
        ],
        "dependencies": [],
    },
